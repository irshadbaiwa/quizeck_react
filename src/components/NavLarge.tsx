...
const NavLarge: React.FC = () => {
  return (
    <nav className="hidden sm:flex flex-row justify-start items-center mx-6">
      <Link
        to="/play"
        className="mx-2 py-2 px-4 rounded-md bg-sky-100 hover:bg-sky-200"
      >
        <div className="flex justify-start items-center">
          <svg
            className="h-6 mr-3 fill-sky-600"
